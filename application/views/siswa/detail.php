<?php if($siswa->num_rows() < 1)
{
    ...
    redirect(base_url('siswa/index'));
     ...
     $this->session->set_flashdata('info_siswa' , '<div class="alert alert-success">Nih data Anda!!</div>');
}
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container mt-3 pt-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div>Nama : <span class="fw-bold"><?=$dt->nama_lengkap;?></span></div>
                <div>NIS  : <span class="fw-bold"><?=$dt->nis;?></span></</div>
            </div>
        </div>
    </div>
