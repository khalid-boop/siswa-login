    ...
    <div class="container mt-3 pt-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <input type="text" name="nama" class="form-control" id="nama"  maxlength="255" value=<?=$dt->nama_lengkap;?> required autofocus>
                <label for="nis">NIS</label>
                <input type="number" name="nis" class="form-control" id="nis" required value="<?=$dt->nis;?>">
